    ...
    <main className={styles.main}>
      ...
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <p className={styles.textSubtitle}>{t.header.subtitle}</p>
        </header>

        <section className={styles.visionCard}>
          <div className={styles.glassEffect}>
            <h2 className={styles.textCardTitle}>{t.vision.title}</h2>
            <p className={styles.textBody}>{t.vision.p1}</p>
            <p className={styles.textBody}>{t.vision.p2}</p>
          </div>
        </section>
        ...
        <div className={styles.grid}>
          <div className={styles.pillCard}>
            ...
            <h3 className={styles.textCardTitle}>
              {t.pillars.problemSolving.title}
            </h3>
            <p className={styles.textBody}>
              {t.pillars.problemSolving.text}
            </p>
          </div>
          ...
          <div className={styles.pillCard}>
            ...
            <h3 className={styles.textCardTitle}>
              {t.pillars.vanguard.title}
            </h3>
            <p className={styles.textBody}>{t.pillars.vanguard.text}</p>
          </div>
        ...
        <footer className={styles.manifesto}>
          ...
          <h2 className={styles.textCardTitle}>{t.manifesto.title}</h2>
          <p className={styles.textBody}>{t.manifesto.text}</p>
        </footer>
      </div>
    </main>
  );
